...
from rl_ros.config import EVADER_ALTITUDE, X_BOUNDS, Y_BOUNDS
...
class EvaderNode(Node):
    ...
    def __init__(self, ns='',
        ...
        self.z_bounds: List[float] = EVADER_ALTITUDE
        if self.use_pn:
        ...
        self.pursuer_sub = self.create_subscription(mavros.local_position.Odometry,
                                                  'uav2/local_position/odom',
                                                  self.pursuer_callback,
                                                  qos_profile=SENSOR_QOS)
        self.pursuer_2_sub = self.create_subscription(mavros.local_position.Odometry,
                                                  'uav2/local_position/odom',
    ...
    def step(self) -> None:
        ...
        if self.won:
            ...
            self.target_location[2] = EVADER_ALTITUDE[0]
